 ...
 *      Author: sid
 *
 *   The origin of this driver was written by Jeroen Domburg <jeroen@spritesmods.com> under "THE BEER-WARE LICENSCE"
 *
 */
...
In short, it's a struct with various URLs plus their handlers. An asterisk will match  any
url starting with everything before the asterisks; "*" matches  everything. The list will
be handled top-down, so make sure to put more specific rules above the more general ones.
*/
...
//Private data for http connectionf
struct HttpdPriv
{
